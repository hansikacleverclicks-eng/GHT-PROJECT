    ...
    <header className="bg-white border-b border-gray-200 py-2">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          {/* Desktop Search Bar - LEFT SIDE with proper width */}
          <div className="hidden md:flex items-center flex-1 max-w-md mr-8">
            <div className="flex border border-gray-300 rounded overflow-visible w-full">
              ...
              <div ref={desktopCityRef} className="relative flex-shrink-0">
                <button
                  type="button"
                  className="flex items-center gap-2 px-3 py-1.5 bg-white text-gray-700 text-sm border-r border-gray-300 min-w-[120px] justify-between hover:bg-gray-50"
          ...
          <div className="hidden md:flex items-center gap-4">
            <Link
              to="/join-as-vendor"
              className="bg-[#101c34] text-white px-5 py-1.5 rounded text-sm font-medium hover:opacity-90 transition-opacity whitespace-nowrap"
            >
              Join as Vendor
            </Link>
          </div>
